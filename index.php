 ...
 ?>
      ...
      <section class="section swiper-container swiper-slider swiper-classic bg-gray-2" data-loop="true" data-autoplay="4000" data-simulate-touch="false" data-slide-effect="fade">
        <div class="swiper-wrapper">
          <div class="swiper-slide text-center" data-slide-bg="<?php echo get_template_directory_uri();?>/images/slider-1-slide-1-1920x671.jpg">
            <div class="container">
          ...
          <div class="swiper-slide" data-slide-bg="<?php echo get_template_directory_uri();?>/images/slider-1-slide-2-1920x671.jpg">
            <div class="container">
          ...
          <div class="swiper-slide" data-slide-bg="<?php echo get_template_directory_uri();?>/images/slider-1-slide-3-1920x671.jpg">
            <div class="container">
              <div class="row">
                <div class="col-xl-5">
                  <div class="swiper-slide-caption">
            ...
            <div class="col-lg-8">
              <div class="main-component">
                ...
                <div class="row row-30">
                  <div class="col-md-6">
                    <!-- Post Future-->
                    <article class="post-future"><a class="post-future-figure" href="#"><img src=" <?php echo get_template_directory_uri();?>/images/news-2-1-368x287.jpg " alt="" width="368" height="287"/></a>
                  ...
                  <div class="col-md-6">
                    <!-- Post Future-->
                    <article class="post-future"><a class="post-future-figure" href="#"><img src=" <?php echo get_template_directory_uri();?>/images/news-2-2-368x287.jpg" alt="" width="368" height="287"/></a>
                      <div class="post-future-main">
                  ...
                  <div class="col-md-6">
                    <!-- Post Future-->
                    <article class="post-future"><a class="post-future-figure" href="#"><img src=" <?php echo get_template_directory_uri();?>/images/news-2-3-368x287.jpg" alt="" width="368" height="287"/></a>
                      <div class="post-future-main">
                  ...
                  <div class="col-md-6">
                    <!-- Post Future-->
                    <article class="post-future"><a class="post-future-figure" href="#"><img src="<?php echo get_template_directory_uri();?>/images/news-2-4-368x287.jpg" alt="" width="368" height="287"/></a>
                      <div class="post-future-main">
                  ...
                  <div class="col-md-12">
                    <!-- Post Gloria-->
                    <article class="post-gloria"><img src="<?php echo get_template_directory_uri();?>/images/post-gloria-1-769x429.jpg" alt="" width="769" height="429"/>
                  ...
                  <div class="col-md-12">
                    <!-- Post Future-->
                    <article class="post-future post-future-horizontal"><a class="post-future-figure" href="#"><img src="<?php echo get_template_directory_uri();?>/images/news-3-1-370x325.jpg" alt="" width="370" height="325"/></a>
                      <div class="post-future-main">
                  ...
                  <div class="col-md-12">
                    <!-- Post Future-->
                    <article class="post-future post-future-horizontal"><a class="post-future-figure" href="#"><img src="<?php echo get_template_directory_uri();?>/images/news-3-2-370x325.jpg" alt="" width="370" height="325"/></a>
                      <div class="post-future-main">
                    ...
                    <div class="swiper-container swiper-slider post-slider" data-loop="false" data-autoplay="false" data-simulate-touch="false">
                      <div class="swiper-wrapper">
                        <div class="swiper-slide">
                          <div class="swiper-slide-caption">
                                                <!-- Post Alice-->
                                                <article class="post-alice"><img src="<?php echo get_template_directory_uri();?>/images/post-slide-1-769x397.jpg" alt="" width="769" height="397"/>
...
Sevens head coach</a></h3>
                        ...
                        <div class="swiper-slide">
                          <div class="swiper-slide-caption">
                                                <!-- Post Alice-->
                                                <article class="post-alice"><img src="<?php echo get_template_directory_uri();?>/images/post-slide-2-769x397.jpg" alt="" width="769" height="397"/>
                                                  <div class="post-alice-main">
                                                    <!-- Badge-->
                                                    <div class="badge badge-primary">The League
                                                    </div>
                        ...
                        <div class="swiper-slide">
                          <div class="swiper-slide-caption">
                                                <!-- Post Alice-->
                                                <article class="post-alice"><img src="<?php echo get_template_directory_uri();?>/images/post-slide-3-769x397.jpg" alt="" width="769" height="397"/>
                                                  <div class="post-alice-main">
                  ...
                  <div class="col-md-12">
                    <!-- Post Future-->
                    <article class="post-future post-future-horizontal"><a class="post-future-figure" href="#"><img src="<?php echo get_template_directory_uri();?>/images/news-3-3-370x325.jpg" alt="" width="370" height="325"/></a>
                      <div class="post-future-main">
                        <h4 class="post-future-title"><a href="#">Zidane: “We’re not going to change the way we play at the Calderón”</a></h4>
                        <div class="post-future-meta">
                          <!-- Badge-->
                  ...
                  <div class="game-info game-info-creative">
                    ...
                    <div class="game-info-main">
                      <div class="game-info-team game-info-team-first">
                        <figure><img src="<?php echo get_template_directory_uri();?>/images/team-sportland-75x99.png" alt="" width="75" height="99"/>
                        </figure>
                      ...
                      <div class="game-info-team game-info-team-second">
                        <figure><img src="<?php echo get_template_directory_uri();?>/images/team-dream-team-91x91.png" alt="" width="91" height="91"/>
                        </figure>
                  ...
                  <div class="owl-carousel-outer-navigation-1">
                    ...
                    <div class="owl-carousel owl-spacing-1" data-items="1" data-dots="false" data-nav="true" data-autoplay="true" data-autoplay-speed="4000" data-stage-padding="0" data-loop="true" data-margin="30" data-mouse-drag="false" data-animation-in="fadeIn" data-animation-out="fadeOut" data-nav-custom=".owl-carousel-outer-navigation-1">
                      ...
                      <article class="game-result game-result-creative">
                        <div class="game-result-main-vertical">
                          <div class="game-result-team game-result-team-horizontal game-result-team-first">
                            <figure class="game-result-team-figure"><img src="<?php echo get_template_directory_uri();?>/images/team-sportland-31x41.png" alt="" width="31" height="41"/>
                            </figure>
                          ...
                          <div class="game-result-team game-result-team-horizontal game-result-team-second">
                            <figure class="game-result-team-figure"><img src="<?php echo get_template_directory_uri();?>/images/team-fenix-40x32.png" alt="" width="40" height="32"/>
                            </figure>
                            <div class="game-result-team-title">
                      ...
                      <article class="game-result game-result-creative">
                        <div class="game-result-main-vertical">
                          <div class="game-result-team game-result-team-horizontal game-result-team-first">
                            <figure class="game-result-team-figure"><img src="<?php echo get_template_directory_uri();?>/images/team-bavaria-fc-26x34.png" alt="" width="26" height="34"/>
                            </figure>
                            <div class="game-result-team-title">
                          ...
                          <div class="game-result-team game-result-team-horizontal game-result-team-second">
                            <figure class="game-result-team-figure"><img src="<?php echo get_template_directory_uri();?>/images/team-athletic-33x30.png" alt="" width="33" height="30"/>
                            </figure>
                            <div class="game-result-team-title">
                ...
                <div class="aside-component">
                  ...
                  <div class="list-post-classic">
                                      ...
                                      <article class="post-classic">
                                        <div class="post-classic-aside"><a class="post-classic-figure" href="#"><img src="<?php echo get_template_directory_uri();?>/images/blog-element-1-94x94.jpg" alt="" width="94" height="94"/></a></div>
                                      ...
                                      <!-- Post Classic-->
                                      <article class="post-classic">
                                        <div class="post-classic-aside"><a class="post-classic-figure" href="#"><img src="<?php echo get_template_directory_uri();?>/images/blog-element-2-94x94.jpg" alt="" width="94" height="94"/></a></div>
                                        <div class="post-classic-main">
                                      ...
                                      <!-- Post Classic-->
                                      <article class="post-classic">
                                        <div class="post-classic-aside"><a class="post-classic-figure" href="#"><img src="<?php echo get_template_directory_uri();?>/images/blog-element-3-94x94.jpg" alt="" width="94" height="94"/></a></div>
                                        <div class="post-classic-main">
                                      ...
                                      <!-- Post Classic-->
                                      <article class="post-classic">
                                        <div class="post-classic-aside"><a class="post-classic-figure" href="#"><img src="<?php echo get_template_directory_uri();?>/images/blog-element-4-94x94.jpg" alt="" width="94" height="94"/></a></div>
                                        <div class="post-classic-main">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td class="team-inline">
                            <div class="team-figure"><img src="<?php echo get_template_directory_uri();?>/images/team-sportland-31x41.png" alt="" width="31" height="41"/>
                            </div>
                        ...
                        <tr>
                          <td><span>2</span></td>
                          <td class="team-inline">
                            <div class="team-figure"><img src="<?php echo get_template_directory_uri();?>/images/team-dream-team-34x34.png" alt="" width="34" height="34"/>
                            </div>
                            <div class="team-title">
                        ...
                        <tr>
                          <td><span>3</span></td>
                          <td class="team-inline">
                            <div class="team-figure"><img src="<?php echo get_template_directory_uri();?>/images/team-real-madrid-28x37.png" alt="" width="28" height="37"/>
                            </div>
                            <div class="team-title">
                        ...
                        <tr>
                          <td><span>4</span></td>
                          <td class="team-inline">
                            <div class="team-figure"><img src="<?php echo get_template_directory_uri();?>/images/team-celta-vigo-35x39.png" alt="" width="35" height="39"/>
                            </div>
                            <div class="team-title">
                        ...
                        <tr>
                          <td><span>5</span></td>
                          <td class="team-inline">
                            <div class="team-figure"><img src="<?php echo get_template_directory_uri();?>/images/team-barcelona-30x35.png" alt="" width="30" height="35"/>
                            </div>
                            <div class="team-title">
                        ...
                        <tr>
                          <td><span>6</span></td>
                          <td class="team-inline">
                            <div class="team-figure"><img src="<?php echo get_template_directory_uri();?>/images/team-bavaria-fc-26x34.png" alt="" width="26" height="34"/>
                            </div>
                            <div class="team-title">
                ...
                <div class="aside-component">
                  ...
                  <div class="owl-carousel owl-carousel-dots-modern awards-carousel" data-items="1" data-autoplay="true" data-autoplay-speed="4000" data-dots="true" data-nav="false" data-stage-padding="0" data-loop="true" data-margin="0" data-mouse-drag="true">
                                      ...
                                      <div class="awards-item"> 
                                        ...
                                        <div class="awards-item-aside"> <img src="<?php echo get_template_directory_uri();?>/images/thumbnail-minimal-1-67x147.png" alt="" width="67" height="147"/>
                                        </div>
                                      </div>
                                      <!-- Awards Item-->
                                      <div class="awards-item"> 
                                        ...
                                        <div class="awards-item-aside"> <img src="<?php echo get_template_directory_uri();?>/images/thumbnail-minimal-2-68x126.png" alt="" width="68" height="126"/>
                                        </div>
                                      </div>
                                      <!-- Awards Item-->
                                      <div class="awards-item"> 
                                        ...
                                        <div class="awards-item-aside"> <img src="<?php echo get_template_directory_uri();?>/images/thumbnail-minimal-3-73x135.png" alt="" width="73" height="135"/>
                                        </div>
                                      </div>
                  </div>
                </div>
                <div class="aside-component">
                  ...
                  <article class="gallery" data-lightgallery="group">
                    <div class="row row-10 row-narrow">
                      <div class="col-6 col-sm-4 col-md-6 col-lg-4"><a class="thumbnail-creative" data-lightgallery="item" href="images/gallery-soccer-1-original.jpg"><img src="<?php echo get_template_directory_uri();?>/images/gallery-soccer-1-212x212.jpg" alt=""/>
                          <div class="thumbnail-creative-overlay"></div></a>
                      </div>
                      <div class="col-6 col-sm-4 col-md-6 col-lg-4"><a class="thumbnail-creative" data-lightgallery="item" href="images/gallery-soccer-2-original.jpg"><img src="<?php echo get_template_directory_uri();?>/images/gallery-soccer-2-212x212.jpg" alt=""/>
                          <div class="thumbnail-creative-overlay"></div></a>
                      </div>
                      <div class="col-6 col-sm-4 col-md-6 col-lg-4"><a class="thumbnail-creative" data-lightgallery="item" href="images/gallery-soccer-3-original.jpg"><img src="<?php echo get_template_directory_uri();?>/images/gallery-soccer-3-212x212.jpg" alt=""/>
                          <div class="thumbnail-creative-overlay"></div></a>
                      </div>
                      <div class="col-6 col-sm-4 col-md-6 col-lg-4"><a class="thumbnail-creative" data-lightgallery="item" href="images/gallery-soccer-4-original.jpg"><img src="<?php echo get_template_directory_uri();?>/images/gallery-soccer-4-212x212.jpg" alt=""/>
                          <div class="thumbnail-creative-overlay"></div></a>
                      </div>
                      <div class="col-6 col-sm-4 col-md-6 col-lg-4"><a class="thumbnail-creative" data-lightgallery="item" href="images/gallery-soccer-5-original.jpg"><img src="<?php echo get_template_directory_uri();?>/images/gallery-soccer-5-212x212.jpg" alt=""/>
                          <div class="thumbnail-creative-overlay"></div></a>
                      </div>
                      <div class="col-6 col-sm-4 col-md-6 col-lg-4"><a class="thumbnail-creative" data-lightgallery="item" href="images/gallery-soccer-6-original.jpg"><img src="<?php echo get_template_directory_uri();?>/images/gallery-soccer-6-212x212.jpg" alt=""/>
                          <div class="thumbnail-creative-overlay"></div></a>
                      </div>
                    </div>
                  </article>
                  ...
                  <div class="block-voting">
                    <div class="group-md">
                      ...
                      <div class="player-voting-item">
                        <div class="player-voting-item-figure"><img src="<?php echo get_template_directory_uri();?>/images/player-5-152x144.jpg" alt="" width="152" height="144"/>
                      ...
                      <!-- Player Voting Item-->
                      <div class="player-voting-item">
                        <div class="player-voting-item-figure"><img src="<?php echo get_template_directory_uri();?>/images/player-6-152x144.jpg" alt="" width="152" height="144"/>
                          <div class="player-number">
                            <p>7</p>
                          </div>
                        </div>
                    ...
                    <div class="owl-carousel owl-spacing-1" data-items="1" data-dots="false" data-nav="true" data-autoplay="true" data-autoplay-speed="4000" data-stage-padding="0" data-loop="false" data-margin="30" data-mouse-drag="false" data-nav-custom=".owl-carousel-outer-navigation">
                      <article class="product">
                        <header class="product-header">
                          ...
                          <div class="product-figure"><img src="<?php echo get_template_directory_uri();?>/images/shop/product-1.png" alt=""/></div>
                      ...
                      <article class="product">
                        <header class="product-header">
                          ...
                          <div class="product-figure"><img src="<?php echo get_template_directory_uri();?>/images/shop/product-2.png" alt=""/></div>
                          <div class="product-buttons">
                            <div class="product-button product-button-share fl-bigmug-line-share27" style="font-size: 22px">
                              <ul class="product-share">
                                <li class="product-share-item"><span>Share</span></li>
                      ...
                      <article class="product">
                        <header class="product-header">
                          ...
                          <div class="product-figure"><img src="<?php echo get_template_directory_uri();?>/images/shop/product-3.png" alt=""/></div>
                          <div class="product-buttons">
                            <div class="product-button product-button-share fl-bigmug-line-share27" style="font-size: 22px">
                              <ul class="product-share">
                                <li class="product-share-item"><span>Share</span></li>
